...
// params:
// 		time.Duration	: period of time between time check
// returns:
...
// AddFunc adds a func to Cron to be executed
// params:
//		time.Time		: Job's execution start time
//		time.Duration 	: Period between job execution
//		interface{}		: function to execute
//		...interface{}  : input argument list of the attached function
// returns:
//		string			: UUID to identify this new created Job
//		err 			: error value (nil if no error)
...
// DelFunc removes a func from Cron
// params
//		string			: UUID to identify the job to be removed
